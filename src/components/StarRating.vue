<template>
  <div class="star-rating">
    <span v-for="index in starLimit" :key="index" class="star star--outlined">
    </span>
    <!-- <div class="star-rating__colored" :style="`width: ${ratingWidth}`"> -->
    <!-- винесемо всю  логіку в компьютед -->
    <div class="star-rating__colored" :style="ratingWidthStyle">
      <span v-for="index in starLimit" :key="index" class="star star--colored">
      </span>
    </div>
  </div>
</template>
